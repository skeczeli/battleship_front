...
const ProfilePage = () => {
  ...
  return (
    <div className="profile-container">
      ...
      <p><strong>Apodo:</strong> {profile.nickname || 'Sin apodo'}</p>
      <p><strong>Partidas ganadas:</strong> {profile.wins}</p>
      <p><strong>Partidas perdidas:</strong> {profile.losses}</p>
      <p><strong>Total jugadas:</strong> {totalGames}</p>
